...
const MyProfile = () => {
  const [userData, setUserData] = useState({
    ...
    email: 'ashwinn@gmail.com',
    phone: '+1 123 234 345',
    Address: {
      line1: "11 street Aussi",
      line2: "Hello road, Australia"
    },
    gender: 'Male',
    dob: '2000-01-20'
  })
          ...
          <p className='font-medium'>Address:</p>
          {
            isEdit
              ? <p><input className='bg-gray-50' onChange={(e) => setUserData(prev => ({ ...prev, address: { ...prev.address, line1: e.target.value } }))} value={userData.address.line1} type="text" />
                <br />
                <input className='bg-gray-50' onChange={(e) => setUserData(prev => ({ ...prev, address: { ...prev.address, line1: e.target.value } }))} value={userData.address.line2} type="text" /></p>
