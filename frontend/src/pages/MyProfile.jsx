    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          {
            isEdit
              ? <input className='bg-gray-100 max-w-52 border p-1 rounded' type="text" value={userData.phone || ''} onChange={e => setUserData(prev => ({ ...prev, phone: e.target.value }))} />
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          {
            isEdit
              ? <input className='max-w-36 bg-gray-100 border p-1 rounded' type="date" onChange={(e) => setUserData(prev => ({ ...prev, dob: e.target.value }))} value={userData.dob || ''} />
