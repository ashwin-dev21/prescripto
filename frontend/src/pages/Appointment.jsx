      ...
      <div className='flex flex-col md:flex-row gap-4'>
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-6 bg-white mx-2 sm:mx-0 mt-4 sm:mt-0'>
          ...
          <div>
            ...
            <p className='text-sm text-gray-600 max-w-176 mt-1'>{docInfo.about}</p>
          </div>
        ...
        <div className='flex items-center gap-3 w-full overflow-x-scroll mt-4'>
          {docSlots.length > 0 && docSlots[slotIndex]?.map((item, index) => (
            <p 
              ...
              className={`text-sm font-light shrink-0 px-5 py-2 rounded-full cursor-pointer ${item.time === slotTime ? 'bg-primary text-white' : 'text-gray-400 border border-gray-400'}`} 
              key={index}
            >
